...
public class Reservation_view extends Frame implements ActionListener,WindowListener,KeyListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		textMessage.setText("");
        if ( arg0.getSource() == buttonVacancy){ // 空き状況確認ボタン
        ...
        else if (arg0.getSource() == buttonReservation){
            result = rcontrol.makeReservation(this);
        }
        
        else if (arg0.getSource() == buttonExplanation){
        	result = rcontrol.getfacilitydata();
        }
        
        else if (arg0.getSource() == buttonConfirm){
        	result = rcontrol.viewReservationData();
        }
